...
# require 'models/ems_refresh/refreshers/orange/refresh_spec_environments'
...
def usage(s)
  $stderr.puts(s)
  $stderr.puts("Usage: bundle exec rails r spec/tools/environment_builders/orange_environments.rb --load")
  $stderr.puts("- loads credentials for #{orange_environment_file} to all refresh tests and VCRs")
  $stderr.puts("Usage: bundle exec rails r spec/tools/environment_builders/orange_environments.rb --obfuscate")
